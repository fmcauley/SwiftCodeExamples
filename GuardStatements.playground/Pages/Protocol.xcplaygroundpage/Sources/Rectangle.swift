...
public struct Rectangle {
    ...
    // example of overriding the default implementation of the protocol in a conforming struct/class
    // first declared in the protocol Movable
